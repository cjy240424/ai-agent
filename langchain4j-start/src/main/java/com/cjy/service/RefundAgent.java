...
public interface RefundAgent {
    ...
    @SystemMessage({
            ...
            "如果用户想要退款，必须识别到'ORD-' 开头的订单编号和退款理由，才能使用退款工具进行退款，绝对不允许凭空捏造订单信息！",
            "退款理由可以是：关于我们家蛋白粉产品味道，成分，安全方面的，也就是关于产品本身的。关于物流运输速度，快递人员态度，即物流方面的。关于自己不想要，买多了，买错了，地址填错了，关于自身相关的。",
